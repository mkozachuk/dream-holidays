!function (t) {
    ...
    r = function (t, e) {
        ...
        l.prototype = {
            ...
            _process_options: function (e) {
                ...
                var o = String(s.orientation).toLowerCase().split(/\s+/g), l = s.orientation.toLowerCase();
                if (o = t.grep(o, function (t) {
                    return /^auto|left|right|top|bottom$/.test(t)
                }), s.orientation = {x: "auto", y: "auto"}, l && "auto" !== l) if (1 === o.length) switch (o[0]) {
                    case"top":
                    case"bottom":
                        s.orientation.y = o[0];
                        break;
                ...
                }), s.orientation.y = l[0] || "auto"; else ;
                if (s.defaultViewDate instanceof Date || "string" == typeof s.defaultViewDate) s.defaultViewDate = g.parseDate(s.defaultViewDate, r, s.language, s.assumeNearbyYear); else if (s.defaultViewDate) {
                    var h = s.defaultViewDate.year || (new Date).getFullYear(), u = s.defaultViewDate.month || 0,
            ...
            place: function () {
                ...
                var e = this.picker.outerWidth(), i = this.picker.outerHeight(), a = t(this.o.container), s = a.width(),
                    n = "body" === this.o.container ? t(document).scrollTop() : a.scrollTop(), r = a.offset(), o = [0];
                ...
                } else this.picker.css({top: p, left: c, zIndex: l});
                return this
            },
            _allow_update: !0,
            update: function () {
            ...
            getClassNames: function (e) {
                var i = [], n = this.viewDate.getUTCFullYear(), r = this.viewDate.getUTCMonth(), o = a();
            ...
            _fill_yearsView: function (i, a, s, n, r, o, l) {
                ...
                }), w = g - p; w <= m + p; w += p) h = [a], u = null, w === g - p ? h.push("old") : w === m + p && h.push("new"), -1 !== t.inArray(w, y) && h.push("active"), (w < r || w > o) && h.push("disabled"), w === v && h.push("focused"), l !== t.noop && ((d = l(new Date(w, 0, 1))) === e ? d = {} : "boolean" == typeof d ? d = {enabled: d} : "string" == typeof d && (d = {classes: d}), !1 === d.enabled && h.push("disabled"), d.classes && (h = h.concat(d.classes.split(/\s+/))), d.tooltip && (u = d.tooltip)), c += '<span class="' + h.join(" ") + '"' + (u ? ' title="' + u + '"' : "") + ">" + w + "</span>";
                f.find(".datepicker-switch").text(g + "-" + m), f.find("td").html(c)
            },
            fill: function () {
                var a, s, n = new Date(this.viewDate), r = n.getUTCFullYear(), o = n.getUTCMonth(),
                    ...
                    c = f[this.o.language].today || f.en.today || "", p = f[this.o.language].clear || f.en.clear || "",
                ...
                if (!isNaN(r) && !isNaN(o)) {
                    ...
                    for (var D, b, k = []; v.valueOf() < w;) {
                        ...
                        var M = v.getUTCDate();
                        this.o.beforeShowDay !== t.noop && ((s = this.o.beforeShowDay(this._utc_to_local(v))) === e ? s = {} : "boolean" == typeof s ? s = {enabled: s} : "string" == typeof s && (s = {classes: s}), !1 === s.enabled && b.push("disabled"), s.classes && (b = b.concat(s.classes.split(/\s+/))), s.tooltip && (a = s.tooltip), s.content && (M = s.content)), b = t.isFunction(t.uniqueSort) ? t.uniqueSort(b) : t.unique(b), k.push('<td class="' + b.join(" ") + '"' + (a ? ' title="' + a + '"' : "") + ' data-date="' + v.getTime().toString() + '">' + M + "</td>"), a = null, D === this.o.weekEnd && k.push("</tr>"), v.setUTCDate(v.getUTCDate() + 1)
                    }
                    ...
                    if (t.each(this.dates, function (t, e) {
                        ...
                        t.each(U, function (i, a) {
                            var s = new Date(r, i, 1), n = E.o.beforeShowMonth(s);
                            n === e ? n = {} : "boolean" == typeof n ? n = {enabled: n} : "string" == typeof n && (n = {classes: n}), !1 !== n.enabled || t(a).hasClass("disabled") || t(a).addClass("disabled"), n.classes && t(a).addClass(n.classes), n.tooltip && t(a).prop("title", n.tooltip)
                        })
                    }
            ...
            updateNavArrows: function () {
                if (this._allow_update) {
                    var t, e, i = new Date(this.viewDate), a = i.getUTCFullYear(), s = i.getUTCMonth(),
            ...
            moveMonth: function (t, e) {
                ...
                var i;
                if (!e) return t;
                var a, s, n = new Date(t.valueOf()), r = n.getUTCDate(), o = n.getUTCMonth(), l = Math.abs(e);
        ...
        h.prototype = {
            ...
            dateUpdated: function (i) {
                if (!this.updating) {
                    ...
                    if (a !== e) {
                        var s = a.getUTCDate(), n = this.keepEmptyValues, r = t.inArray(i.target, this.inputs),
                            o = r - 1, l = r + 1, h = this.inputs.length;
                        if (-1 !== r) {
                            if (t.each(this.pickers, function (t, e) {
                                e.getUTCDate() || e !== a && n || e.setUTCDate(s)
                            }), s < this.dates[o]) for (; o >= 0 && s < this.dates[o];) this.pickers[o--].setUTCDate(s); else if (s > this.dates[l]) for (; l < h && s > this.dates[l];) this.pickers[l++].setUTCDate(s);
        ...
        var u = t.fn.datepicker, d = function (i) {
            ...
            if (s.shift(), this.each(function () {
                var e = t(this), n = e.data("datepicker"), r = "object" == typeof i && i;
                if (!n) {
                    var o = function (e, i) {
                    ...
                    }(t.extend({}, c, o, r).language), d = t.extend({}, c, u, o, r);
                    e.hasClass("input-daterange") || d.inputs ? (t.extend(d, {inputs: d.inputs || e.find("input").toArray()}), n = new h(this, d)) : n = new l(this, d), e.data("datepicker", n)
                }
        ...
        var f = t.fn.datepicker.dates = {
            ...
            parseDate: function (i, s, n, r) {
                ...
                var o, h, u, d, c, p = {d: "moveDay", m: "moveMonth", w: "moveWeek", y: "moveYear"},
                    m = {yesterday: "-1d", today: "+0d", tomorrow: "+1d"};
                ...
                var v, y, w = {}, D = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], b = {
                    yyyy: function (t, e) {
                ...
                function C() {
                    var t = this.slice(0, o[d].length), e = o[d].slice(0, t.length);
    ...
    jQuery && "undefined" != typeof jQuery && (jQuery.fn.customSlider = function (t) {
        ...
        if ([{prop: "start", example: "start: [25, 70]"}, {
            prop: "range",
        ...
        }), this.length && void 0 !== this[0]) for (var i = 0; i < this.length; i++) {
            s.a.create(this[i], t);
    ...
    s = [], void 0 === (n = "function" == typeof (a = function () {
        ...
        function g(t, e, i) {
            ...
            var a = (i.xVal[t + 1] - i.xVal[t]) / i.xNumSteps[t], s = Math.ceil(Number(a.toFixed(3)) - 1),
        ...
        function N(e, i) {
            ...
            var a = i.indexOf("tap") >= 0, s = i.indexOf("drag") >= 0, n = i.indexOf("fixed") >= 0,
                r = i.indexOf("snap") >= 0, o = i.indexOf("hover") >= 0;
            if (n) {
                if (2 !== e.handles) throw new Error("noUiSlider (" + t + "): 'fixed' behaviour must be used with 2 handles");
                M(e, e.start[1] - e.start[0])
            }
            e.events = {tap: a || r, drag: s, fixed: n, snap: r, hover: o}
        }
        ...
        function P(e, i) {
            ...
            if ("string" == typeof e.cssPrefix) for (var a in e.cssClasses = {}, i) i.hasOwnProperty(a) && (e.cssClasses[a] = e.cssPrefix + i[a]); else e.cssClasses = i
        }
        ...
        function z(e) {
            var i = {margin: 0, limit: 0, padding: 0, animate: !0, animationDuration: 300, ariaFormat: v, format: v},
                a = {
                    step: {r: !1, t: w},
                    start: {r: !0, t: b},
                    connect: {r: !0, t: S},
        ...
        function j(i, n, h) {
            var u, d, c, p, f, g, m, v, y = window.navigator.pointerEnabled ? {
                ...
                w = window.CSS && CSS.supports && CSS.supports("touch-action", "none") && function () {
                    ...
                    return t
                }(), D = i, b = [], k = [], C = 0, x = n.spectrum, S = [], _ = {}, M = i.ownerDocument,
                T = M.documentElement, U = M.body;
            ...
            function F(t, e, i) {
                ...
                function u(t, e) {
                    var i = e === n.cssClasses.value, a = i ? s : o;
            ...
            function A(e) {
                ...
                var i, a, s, n, r, o, l, h, u, d, c = e.mode, p = e.density || 1, g = e.filter || !1,
                    ...
                    v = (i = p, a = c, s = m, r = {}, o = x.xVal[0], l = x.xVal[x.xVal.length - 1], h = !1, u = !1, d = 0, n = s.slice().sort(function (t, e) {
                        ...
                        var n, o, l, c, p, f, g, m, v, y = t, w = s[e + 1];
                        if ("steps" === a && (n = x.xNumSteps[e]), n || (n = w - y), !1 !== y && void 0 !== w) for (n = Math.max(n, 1e-7), o = y; o <= w; o = (o + n).toFixed(7) / 1) {
                    ...
                    }), r), y = e.format || {to: Math.round};
                return f = D.appendChild(F(v, g, y))
            }

            function Y() {
                var t = u.getBoundingClientRect(), e = "offset" + ["Width", "Height"][n.ort];
            ...
            function P(t, e, i, a) {
                var s = function (s) {
                    return !D.hasAttribute("disabled") && (r = D, o = n.cssClasses.tap, (r.classList ? !r.classList.contains(o) : !new RegExp("\\b" + o + "\\b").test(r.className)) && (!!(s = function (t, e, i) {
                        var a, s, r = 0 === t.type.indexOf("touch"), o = 0 === t.type.indexOf("mouse"),
            ...
            function W(t) {
                var e, i, a, s, r, o,
                    h = 100 * (t - (e = u, i = n.ort, a = e.getBoundingClientRect(), s = e.ownerDocument, r = s.documentElement, o = l(s), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (o.x = 0), i ? a.top + o.y - r.clientTop : a.left + o.x - r.clientLeft)) / Y();
                return n.dir ? 100 - h : h
            }

            function j(t, e, i, a) {
                var s = i.slice(), n = [!t, t], r = [t, !t];
            ...
            function q(t, i) {
                ...
                var o = [], l = P(y.move, T, I, {
                        ...
                        locations: b.slice()
                    }), h = P(y.end, T, R, {target: t.target, handle: a, listeners: o, handleNumbers: i.handleNumbers}),
                    u = P("mouseout", T, H, {
                        target: t.target,
                        handle: a,
                        listeners: o,
            ...
            function B(t) {
                t.stopPropagation();
                var e, i, s, r = W(t.calcPoint), o = (e = r, i = 100, s = !1, d.forEach(function (t, a) {
                ...
                if (!1 === o) return !1;
                n.events.snap || a(D, n.cssClasses.tap, n.animationDuration), K(o, r, !0, !0), $(), L("slide", o, !0), L("update", o, !0), L("change", o, !0), L("set", o, !0), n.events.snap && q(t, {handleNumbers: [o]})
            }

            function J(t) {
                var e = W(t.calcPoint), i = x.getStep(e), a = x.fromStepping(i);
            ...
            function $() {
                k.forEach(function (t) {
                    var e = b[t] > 50 ? -1 : 1, i = 3 + (d.length + e * t);
            ...
            return r(g = D, n.cssClasses.target), 0 === n.dir ? r(g, n.cssClasses.ltr) : r(g, n.cssClasses.rtl), 0 === n.ort ? r(g, n.cssClasses.horizontal) : r(g, n.cssClasses.vertical), u = E(g, n.cssClasses.base), function (t, e) {
                d = [], (c = []).push(N(e, t[0]));
                ...
                destroy: function () {
                    ...
                    return b.map(function (t, e) {
                        var i = x.getNearbySteps(t), a = S[e], s = i.thisStep.step, n = null;
                ...
                }, on: it, off: function (t) {
                    var e = t && t.split(".")[0], i = e && t.substring(e.length);
                    Object.keys(_).forEach(function (t) {
                        var a = t.split(".")[0], s = t.substring(a.length);
                        e && e !== a || i && i !== s || delete _[t]
                    })
                }, get: et, set: tt, reset: function (t) {
                    tt(n.start, t)
                }, __moveHandles: function (t, e, i) {
                    j(t, e, b, i)
                }, options: h, updateOptions: function (t, e) {
                    var i = et(), a = ["margin", "limit", "padding", "range", "animate", "snap", "step", "format"];
                ...
                }, target: D, removePips: O, pips: A
            }, (m = n.events).fixed || d.forEach(function (t, e) {
                P(y.start, t.children[0], q, {handleNumbers: [e]})
            }), m.tap && P(y.start, u, B, {}), m.hover && P(y.move, u, J, {hover: !0}), m.drag && c.forEach(function (t, e) {
                if (!1 !== t && 0 !== e && e !== c.length - 1) {
                    var i = d[e - 1], a = d[e], s = [t];
                    r(t, n.cssClasses.draggable), m.fixed && (s.push(i.children[0]), s.push(a.children[0])), s.forEach(function (t) {
                        P(y.start, t, q, {handles: [i, a], handleNumbers: [e - 1, e]})
                    })
                }
                ...
                k.forEach(function (t) {
                    var e = d[t], a = Q(b, t, 0, !0, !0, !0), r = Q(b, t, 100, !0, !0, !0), o = s[t],
